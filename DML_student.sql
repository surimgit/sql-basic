...
-- [AAA, 국어, 1, null]
-- [AA, 수학, 2, null]
INSERT INTO class(class_code, name, class_room) VALUES('25001', '국어', 1);
INSERT INTO class(class_code, name, class_room) VALUES('25001', '수학', 2);
...
-- [2000060202, 김선달, null, 010-2222-3333, null]
...
INSERT INTO teacher VALUES('2000060202', '김선달', null, '010-2222-3333', null);

-- 5. 수업 코드가 'AAA'인 수업에 대해 담당교사를 '2000010102'로 지정
UPDATE class SET class_teacher = '2000010102' WHERE class_code = 'AAA';

-- 6. 직책이 정해지지 않은 교사에 대해서 직책을 '교생'으로 지정
UPDATE teacher SET position = '교생' WHERE position IS NULL;

-- 7. 교실의 좌석수가 25개 이상인 교실을 조회
SELECT class_room_number, seats FROM class_room WHERE seats >= 25;

-- 8. 학생 중 부산 진구에 거주하는 학생의 이름을 조회
